...
class ProgressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post progresses_url, params: { progress: { lesson_id: @progress.lesson_id, student_id: @progress.student_id } }
    end
  ...
  test "should update progress" do
    patch progress_url(@progress), params: { progress: { lesson_id: @progress.lesson_id, student_id: @progress.student_id } }
